...
},{}],"components/Html5VideoBlock.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $388068 = exports.default || module.exports;
      
      if (typeof $388068 === 'function') {
        $388068 = $388068.options;
      }
    
        /* template */
        Object.assign($388068, (function () {
          var render = function() {
  var _vm = this
          ...
          _vm.attrs.src
            ? [
                _c(
                  ...
                  {
                    ref: "element",
                    staticClass: "k-editor-html5video-block-wrapper",
                    style: _vm.style,
                    attrs: {
                  ...
                  [
                    _c("video", {
                      ...
                      on: {
                        dblclick: _vm.selectFile,
                        loadedmetadata: _vm.onLoad
                      }
                    })
                  ]
                ),
                  ...
                  [
                    _c("k-editable", {
                      attrs: {
                        ...
                        placeholder:
                          _vm.$t(
                            "editor.blocks.html5video.caption.placeholder"
                          ) + "…",
            ...
            : [
                _c(
                  ...
                  {
                    ref: "element",
                    staticClass: "k-editor-html5video-block-placeholder",
                    attrs: { tabindex: "0" },
                    on: { drop: _vm.onDrop },
                    nativeOn: {
                      keydown: [
                  ...
                  [
                    _c(
                      ...
                      [
                        _vm._v(
                          _vm._s(_vm.$t("editor.blocks.html5video.upload"))
                        )
                      ]
                    ),
                    _vm._v(
                      "\n        " +
                        _vm._s(_vm.$t("editor.blocks.html5video.or")) +
                        "\n        "
                    ),
                    _c(
                      "k-button",
                      ...
                      [
                        _vm._v(
                          _vm._s(_vm.$t("editor.blocks.html5video.select"))
                        )
                      ]
                    )
                  ],
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$388068', $388068);
          } else {
            api.reload('$388068', $388068);
          }
        }
...
var _Html5VideoBlock = _interopRequireDefault(require("./components/Html5VideoBlock.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

editor.block("html5video", _Html5VideoBlock.default);
},{"./components/Html5VideoBlock.vue":"components/Html5VideoBlock.vue"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "55697" + '/');
